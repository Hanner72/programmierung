...
* [SwiftMailer](https://swiftmailer.symfony.com) - A mailer solution.
  ...
  * Doku - https://swiftmailer.symfony.com/docs/introduction.html
  * Login Tutorial mit SwiftMailer - https://youtu.be/C-ZSQMbsm7A?list=PL3pyLl-dgiqDt7xKIdvhoSKrR7KqIQ9PQ&t=238
...
* [TCPDF](https://tcpdf.org/) - zum einfachen erstellen von PDFs
  * Beispiele - https://tcpdf.org/examples/
  * Referenzliste und Befehlliste - https://www.rubydoc.info/gems/rfpdf/1.17.4/TCPDF -> aktuall
...
* [Animate.css](https://animate.style/) - Eine CSS Klasse um Elemente auf der HP zu animieren
  * einfügen per CDN
    ```html
